...
public class DateTimePickerSkin extends DatePickerSkin {
    ...
    public Node getPopupContent() {
        if (ret == null) {
            ...
            Label hoursValue = new Label(MainApp.resourceMessage.getString("time.hour")+": " + (datePicker.getTimeValue() != null ? datePicker.getTimeValue().getHour() : "") + " ");

            Slider minutes = new Slider(0, 59, (datePicker.getTimeValue() != null ? datePicker.getTimeValue().getMinute() : 0));
            Label minutesValue = new Label(MainApp.resourceMessage.getString("time.minute")+": " + (datePicker.getTimeValue() != null ? datePicker.getTimeValue().getMinute() : "") + " ");

            Slider seconds = new Slider(0, 59, (datePicker.getTimeValue() != null ? datePicker.getTimeValue().getSecond() : 0));
            Label secondsValue = new Label(MainApp.resourceMessage.getString("time.second")+": " + (datePicker.getTimeValue() != null ? datePicker.getTimeValue().getSecond() : "") + " ");
            ...
            hours.valueProperty().addListener((observable, oldValue, newValue) -> {
                ...
                hoursValue.setText(MainApp.resourceMessage.getString("time.hour")+": " + String.format("%02d", datePicker.getTimeValue().getHour()) + " ");
            });
            ...
            minutes.valueProperty().addListener((observable, oldValue, newValue) -> {
                ...
                minutesValue.setText(MainApp.resourceMessage.getString("time.minute")+": " + String.format("%02d", datePicker.getTimeValue().getMinute()) + " ");
            });
            ...
            seconds.valueProperty().addListener((observable, oldValue, newValue) -> {
                ...
                secondsValue.setText(MainApp.resourceMessage.getString("time.second")+": " + String.format("%02d", datePicker.getTimeValue().getSecond()) + " ");
            });
